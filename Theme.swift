...
public  let  HeadViewHeight:CGFloat = 150
public   let    IconViewHeight :CGFloat = 150.0
// MARK: - 购物车管理工具通知
public let LFBShopCarDidRemoveProductNSNotification = "LFBBShopCarDidRemoveProductNSNotification"
/// 购买商品数量发生改变
